...
const TvCable =()=>{
  ...
  <Fragment className="containerOne"  >
    ...
    <button aria-label="Cable de la Costa">Cable de la Costa</button>
     ...
     <button aria-label="Tv Cable Sur" >Tv Cable Sur</button>
    <button aria-label="Vtr Cuenta">Vtr Cuenta</button>
    <button aria-label="Directv Instalaciones">Directv Instalaciones</button>
    <button aria-label="Directv Mensualidades" >Directv Mensualidades</button>
