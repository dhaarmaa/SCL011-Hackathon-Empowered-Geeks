...
const WaterCompanies =()=>{
  ...
  <Fragment >
    ...
    <button aria-label="Aguas Andinas">Aguas Andinas</button>
    <button aria-label="Aguas Antofagastas">Aguas Antofagastas</button>
    <button aria-label="Aguas Araucania">Aguas Araucania</button>
    <button aria-label="Aguas Chañar">Aguas Chañar</button>
    <button aria-label="Aguas Cordillera">Aguas Cordillera</button>
    <button aria-label="Aguas Decima">Aguas Decima</button>
    <button aria-label="Agual del Valle">Agual del Valle</button>
    <button aria-label="Aguas Magallanes">Aguas Magallanes</button>
    <button aria-label="Aguas Manquehue">Aguas Manquehue</button>
    <button aria-label="Aguas Patagonia de Aysen">Aguas Patagonia de Aysen</button>
    <button aria-label="Aguas Pirque S.A.">Aguas Pirque S.A.</button>
